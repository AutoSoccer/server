...
| US-057 | Deploy de homologação (Render staging + Cloudways prod) | 4 | B | 5 | Done | `71ad710` [server] chore(deploy): adiciona render.yaml, `4c5803a` [server] chore(deploy): usa yarn no build do render, `023cb17` [server] docs(readme): documenta processo de deploy |
