...
layout arcade pronto e bullets placeholder (em _italico cinza, entre
[colchetes]_) dizendo exatamente o que cada integrante deve preencher.
...
- Substitua cada bullet `[entre colchetes]` por conteudo real e troque o
  estilo de _italico cinza_ para o texto claro normal (`#E2E8F0`).
